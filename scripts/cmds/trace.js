...
const adminName = "𝐒𝐊 𝐒𝐈𝐃𝐃𝐈𝐊"; // Replace with your admin's name
const adminUID = global.GoatBot.config.DEV; // Replace with your admin's UID
const adminLink = "https://www.facebook.com/TERA.PAPPA.IS.BUSY"; // Replace with your admin's profile link
